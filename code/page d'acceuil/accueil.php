...
<body>
	<header class="headerr">
		...
		<nav class="navbar">
			...
			<a href="home_produit.php"><i class="fas fa-shopping-basket">Produits</i></a>
			<a href="contact.html"><i class="fa fa-address-card">Contact</i></a>
            <a href="../connexion page client/logout_form_amélioré.php"><i class="fas fa-door-open">Déconnexion</i></a>
		</nav>
	</header>
...
<p style="margin-left: 45%;"><span style="font-weight:bold; font-size: 30px;">Nos Produits</span></p>
    ...
    <footer>
        ...
        <div class="footerBottom">
            <p>&copy; 2024 Tous droits sont reservés. <span class="designer">par Lamine Dieng</span></p>
        </div>
    </footer>
</body>
</html>
...
<?php 
    ...
    header("location:../connexion page client/index.php");
	exit();
}
